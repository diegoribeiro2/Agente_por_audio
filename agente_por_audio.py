...
class TalkingLLM():
    def __init__(self, model='gpt-3.5-turbo-0125', whisper_size="small"):
    ...
    def start_or_stop_recording(self):
        if self.is_recording:
            ...
            print("Iniciando a gravação de audio ...")
            self.audio_data = []
            self.is_recording = True

    def create_agent(self):
        agent_prompt_prefix = """
            Você se chama Analisador de Dados, e está trabalhando com dataframe pandas no Python. O nome do Dataframe é `df`.
        """
    ...
    def convert_and_play(self):
        ...
        while True:
            ...
            if '.' in tts_text or '?' in tts_text or '!' in tts_text:
                ...
                print('\nEstou rodando novamente. Pressione Ctrl para iniciar ou parar a gravação de audio.')


    def run(self):
        print('Estou rodando. Pressione Ctrl para iniciar ou parar a gravação de audio.')
